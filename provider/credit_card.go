...
func NewCreditCard() *CreditCard {
    visa_prefix_list := [][]string{[]string{"4", "5", "3", "9"},
                                []string{"4", "5", "5", "6"},
                                []string{"4", "9", "1", "6"},
                                []string{"4", "5", "3", "2"},
                                []string{"4", "9", "2", "9"},
    ...
    mastercard_prefix_list := [][]string{[]string{"5", "1"},
                                         []string{"5", "2"},
                                         []string{"5", "3"},
                                         []string{"5", "4"},
                                         []string{"5", "5"},
    ...
    amex_prefix_list := [][]string{[]string{"3", "4"},
                                   []string{"3", "7"},
                                }

    discover_prefix_list := [][]string{[]string{"6", "0", "1", "1"}}  

    diners_prefix_list := [][]string{[]string{"3", "0", "0"},
                                         []string{"3", "0", "1"},
                                         []string{"3", "0", "2"},
                                         []string{"3", "6"},
                                         []string{"3", "8"},
    ...
    enroute_prefix_list := [][]string{[]string{"2", "0", "1", "4"},
                                   []string{"2", "1", "4", "9"},
                                }

    jcb16_prefix_list := [][]string{[]string{"3", "0", "8", "8"},
                                   []string{"3", "0", "9", "6"},
                                   []string{"3", "1", "1", "2"},
                                   []string{"3", "1", "5", "8"},
                                   []string{"3", "3", "3", "7"},
    ...
    jcb15_prefix_list := [][]string{[]string{"2", "1", "0", "0"},
                                   []string{"1", "8", "0", "0"},
                                }
