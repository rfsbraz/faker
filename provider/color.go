...
func NewColor() *Color {
	...
	color := Color{Provider{}, allColors, safeColors}
...
func (color *Color) RGBColor() string {
	rgb_color := color.RGBColorList()
	return fmt.Sprintf("%d,%d,%d", rgb_color[0], rgb_color[1], rgb_color[2])
}

func (color *Color) RGBCSSColor() string {
	return fmt.Sprintf("rgb(%s)", color.RGBColor())
}
